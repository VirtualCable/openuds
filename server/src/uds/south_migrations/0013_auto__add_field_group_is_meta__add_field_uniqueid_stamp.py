...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UniqueId.stamp'
        db.add_column(u'uds_uniqueid', 'stamp',
                      self.gf('django.db.models.fields.IntegerField')(default=0, db_index=True),
                      keep_default=False)

        if not db.dry_run:
            orm.UniqueId.objects.all().update(stamp=time.time())
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'UniqueId.stamp'
        db.delete_column(u'uds_uniqueid', 'stamp')
