...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Authenticator.small_name'
        db.add_column('uds_authenticator', 'small_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, db_index=True),
                      keep_default=False)
        if not db.dry_run:
            n = 0
            for a in orm.Authenticator.objects.all().order_by('priority', 'name'):
                a.small_name = 'Auth' + str(n)
                a.save()
                n = n + 1

    def backwards(self, orm):
        # Deleting field 'Authenticator.small_name'
        db.delete_column('uds_authenticator', 'small_name')
    ...
    models = {
        'uds.authenticator': {
            ...
            'small_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '32', 'db_index': 'True'})
        },
        'uds.cache': {
