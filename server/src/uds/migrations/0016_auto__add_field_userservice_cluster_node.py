...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserService.cluster_node'
        db.add_column(u'uds__user_service', 'cluster_node',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=128, null=True, db_index=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserService.cluster_node'
        db.delete_column(u'uds__user_service', 'cluster_node')
