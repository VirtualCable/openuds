...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Group.meta_if_any'
        db.add_column(u'uds_group', 'meta_if_any',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Group.meta_if_any'
        db.delete_column(u'uds_group', 'meta_if_any')
    ...
    models = {
        ...
        u'uds.deployedservice': {
            ...
            'state': ('django.db.models.fields.CharField', [], {'default': "u'A'", 'max_length': '1', 'db_index': 'True'}),
        ...
        u'uds.deployedservicepublication': {
            ...
            'state': ('django.db.models.fields.CharField', [], {'default': "u'P'", 'max_length': '1', 'db_index': 'True'}),
        ...
        u'uds.group': {
            ...
            'meta_if_any': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'uds.network': {
            'Meta': {'ordering': "(u'name',)", 'object_name': 'Network'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'uds.scheduler': {
            ...
            'state': ('django.db.models.fields.CharField', [], {'default': "u'X'", 'max_length': '1', 'db_index': 'True'})
        },
        u'uds.service': {
        ...
        u'uds.userservice': {
            ...
            'cluster_node': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '128', 'null': 'True', 'db_index': 'True', 'blank': 'True'}),
            ...
            'os_state': ('django.db.models.fields.CharField', [], {'default': "u'P'", 'max_length': '1'}),
