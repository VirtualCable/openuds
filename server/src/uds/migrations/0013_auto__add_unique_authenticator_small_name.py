...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing index on 'Authenticator', fields ['small_name']
        db.delete_index('uds_authenticator', ['small_name'])

        # Adding unique constraint on 'Authenticator', fields ['small_name']
        db.create_unique('uds_authenticator', ['small_name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Authenticator', fields ['small_name']
        db.delete_unique('uds_authenticator', ['small_name'])

        # Adding index on 'Authenticator', fields ['small_name']
        db.create_index('uds_authenticator', ['small_name'])
    ...
    models = {
        'uds.authenticator': {
            ...
            'small_name': ('django.db.models.fields.CharField', [], {'default': "''", 'unique': 'True', 'max_length': '32'})
        },
        'uds.cache': {
